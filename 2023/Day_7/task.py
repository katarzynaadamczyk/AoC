...
solution 1 - create a list of hands sorted by its kind and then by the priority of each card, 
then add to hands_dict rank of each hand, then sum the results of multiplication of bid and rank for each hand
